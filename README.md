...
## 🔌 Loxone – vytvoření proměnných (Virtual Inputs) - Není nutné měnit, ale v pravé části si můžete upravit názvy proměnných nebo přidat další, pokud se objeví nové
